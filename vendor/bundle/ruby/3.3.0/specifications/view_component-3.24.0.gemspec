# -*- encoding: utf-8 -*-
# stub: view_component 3.24.0 ruby lib

Gem::Specification.new do |s|
  s.name = "view_component".freeze
  s.version = "3.24.0".freeze
  ...
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 5.2.0".freeze, "< 8.2".freeze])
  ...
  s.add_development_dependency(%q<propshaft>.freeze, ["~> 1.1.0".freeze])
end
